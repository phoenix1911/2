...
public class GoodWanServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			gdao.jieshu(g.getGno(),df.parse(df.format(date)));
	   ...
	   RequestDispatcher view = request.getRequestDispatcher("goodfindyi.do");
